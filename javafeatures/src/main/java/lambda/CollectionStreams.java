...
public class CollectionStreams {
    ...
    static void testFilter(List<PersonDTO> personDTOS){
        ...
        Predicate<PersonDTO> predicate = personDTO -> { return personDTO.getName().equals("山大王");};
        //personDTOStream.filter(predicate);
        // 只保留那些叫 "山大王"的person
        Stream<PersonDTO> filterPersonDTOStream = personDTOStream.filter(personDTO -> { return personDTO.getName().equals("山大王");});
