...
public class Lambdas {
    ...
    static void testFunction(){
        ...
        // 乘以100的
        Function<Integer, Integer> mul100 = a -> { return 100 * a;};
    ...
    static void testConsumer(){
        BiConsumer<Integer, PersonDTO> consumer = (a, b)->{ System.out.print("\n性别是：" + b.getGander());};
    ...
    static void testSupplier(){
        ...
        Supplier<List<PersonDTO>> supplier = () -> { return Arrays.asList(personDTO);};
